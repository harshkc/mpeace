    ...
    <div>
      {user ? (
        <div style={{display: "inline"}}>
          <Button className={classes.userBtn} onClick={handleOpenMenu} endIcon={<KeyboardArrowDownIcon />}>
            <Avatar
              alt={user.username}
          ...
          <Menu
            ...
            elevation={1}
          >
            <MenuItem component={RouterLink} to={`/user/${user.username}`} onClick={handleCloseMenu}>
