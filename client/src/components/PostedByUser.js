...
const ByUser = ({username, userId, createdAt, updatedAt, filledVariant, isAnswer}) => {
  const classes = useQuesCardStyles();

  return (
    <div className={filledVariant ? classes.filledByUser : classes.byUserWrapper}>
      <Avatar
        src={`https://secure.gravatar.com/avatar/${userId}?s=164&d=monsterid`}
        alt={username}
