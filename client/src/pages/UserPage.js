  ...
  return (
    <div className={classes.root}>
      <div className={classes.userCard}>
        <Avatar
          src={`https://secure.gravatar.com/avatar/${id}?s=164&d=monsterid`}
          alt={username}
      ...
      <div className={classes.infoCard}>
        <div className={classes.userInfo}>
          <div>
            <Typography variant='h5' color='primary' className={classes.bigText}>
        ...
        <div className={classes.recentActivity}>
          ...
          <div>
            ...
            {recentAnswers.length !== 0 ? (
              ...
              <Typography variant='subtitle1'>No questions answered yet.</Typography>
            )}
          </div>
        </div>
      </div>
