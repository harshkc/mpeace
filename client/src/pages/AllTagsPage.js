...
const AllTagsPage = () => {
  ...
  return (
    <div className={classes.root}>
      <Typography variant='h4' className={classes.titleText} color='secondary'>
        Tags
      </Typography>
      <Typography variant='body1'>
        A tag is a keyword or label that categorizes your question with other, similar questions. Using <br />
      ...
      {!loading && data ? (
        <div className={classes.tagsWrapper}>
          {data.getAllTags
            .filter((t) => t.tagName.toLowerCase().includes(filterInput.toLowerCase()))
            .map((t) => (
